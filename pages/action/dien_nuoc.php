...
try {
    ...
    // Dữ liệu thợ
    $tho= $conn->prepare("select * FROM info_worker where status_worker = 0 and today_off = 0 and kind_worker like '%nước%' order by name_worker ASC ");
    $tho->setFetchMode(PDO::FETCH_ASSOC); // set kiểu mảng cho giá trị trả về
    $tho->execute();
    $rs = $tho->fetchAll();
    
    // đổ toàn bộ dự liệu thu đã phân
    $sql = "SELECT info_cus.id_cus,info_cus.name_cus, info_cus.phone_cus,info_cus.add_cus, info_cus.des_cus,info_cus.yc_book, info_cus.note_book,info_worker.name_worker,info_cus.date_book, work_do.id_work, nv_phan, phu, sum_thu, sum_chi, thongtinthem , note_work, thanh_toan, kind_book FROM work_do,info_worker,info_cus WHERE  info_cus.date_book like '%$timelive%'and work_do.id_worker = info_worker.id_worker and work_do.id_cus = info_cus.id_cus and info_cus.kind_book like '%nuoc%'
...
<div class='container-fluid>
    <div class='row'>
        <div class = 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col_left' >
            <h3 class='lichXL'>Lịch Điện Nước Chưa Xử Lý</h3>
                                            ...
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    <form action='includes/logic/XL_phan_lich.php' method='POST' class='modal-body'>
                                                        ...
                                                        <select name='name_worker' class= 'form-controler'>";
                                                            foreach ($rs as $row1) {
                                                                echo '<option>';  
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="padding-top:3px;">
                                <?php // thu chi
                                    ...
                                    <div id='my3".$row['id_cus']."' class='modal fade' role='dialog'>
                                        ...
                                        <div class='modal-content modal_content1'>
                                                ...
                                                <input type='hidden' name ='id_work' value=".$row['id_work']." >
                                                    ...
                                                    <input type='number' min='0.00' max='1000000000.00' step='0.01'  name='sumthu' value=".$row['sum_thu']." id='sumthu'/>
                                                    <label for='text'><b>Tổng Chi  : </b></label>
                                                    <input type='number' min='0.00' max='1000000000.00' step='0.01'  name='sumchi' value=".$row['sum_chi']." id='sumchi'>
                                    ...
                                    echo"
                                <button type='button' data-toggle='modal' data-target='#my4".$row['id_cus']."'class='btn btn-sm btn-warning tooltipButton cls_btn' data-tooltip='Sửa'><i class='fa fa-pencil' aria-hidden='true'></i></button>
                                <!-- Modal -->
                                <div id='my4".$row['id_cus']."' class='modal fade' role='dialog'>
                                    <!-- Modal content-->
                                    <div class='modal-content modal_content1'>
                                            <div class='modal-header'>
                                                <button type='button' class='close' data-dismiss='modal'>&times;</button>
