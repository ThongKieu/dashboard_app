                        ...
                        <tr>
                            <th >".htmlspecialchars($row3['yc_book'])."</th>
                                ...
                                <td style='text-align:center'>
                                    <button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#phantho".$row3['id_cus']."'style='margin-top:5px; padding:5px 14px;'>Phân</button>
                                    <!-- Modal -->
                                    ...
                                    echo "<a href ='".BASE_URL."includes/logic/suaKH.php?id_cus=".$row3['id_cus']."&action=coppy&nv=".$ruser['real_name']." 'class='btn btn-sm btn-info' style='margin-top:5px; padding:5px 23px;'><i class='fa fa-superscript'></i></a>";
                                    echo "<a href ='".BASE_URL."includes/logic/suaKH.php?id_cus=".$row3['id_cus']."&action=sua&nv=".$ruser['real_name']." 'class='btn btn-sm btn-success'style='margin-top:5px; padding:5px 23px;'><i class='fa fa-pencil' aria-hidden='true' ></i></a>";
                                    echo"
                                    <button type='button' class='btn btn-sm btn-danger' data-toggle='modal' data-target='#my".$row3['id_cus']."'style='margin-top:5px; padding: 5px 23px;'><i class='fa fa-trash' aria-hidden='true'></i></button>
        ...
        <tbody>
            <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td>
                            <?php 
                                echo "<button href ='".BASE_URL."includes/logic/thu_chi.php?id_work=".$row['id_work']."&idq=1&ki=3'class='btn btn-sm btn-success'>Nhập</button>";
                                echo " </td> <td>";
								echo "<button href ='".BASE_URL."includes/logic/XL_sua_lich_da_phan.php?id_work=".$row['id_work']."'class='btn btn-sm btn-warning' style='padding: 5px 15px; margin-right: 5px;'><i class='fa fa-pencil' aria-hidden='true'></i></button>";
                                echo"<button href ='".BASE_URL."includes/logic/deleteKH.php?hd=ks&id_cus=".$row['id_cus']."'class='btn btn-sm btn-primary' style='padding: 5px 15px;'>KSát</button>";
                                echo"<button type='button' class='btn btn-sm btn-danger' data-toggle='modal' data-target='#my".$row['id_cus']."'style='margin-top: 5px; padding: 5px 16px; margin-right: 1px;'><i class='fa fa-trash' aria-hidden='true'></i></button>
                                ...
                                echo "<button href ='".BASE_URL."includes/logic/thuhoi.php?id_cus=".$row['id_cus']."&ki=3 'class='btn btn-sm btn-warning'style='padding: 5px 19px; margin-top: 5px;'><i class='fa fa-ban'></i></button>";
                                ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
